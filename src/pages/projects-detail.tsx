        ...
        <div className="relative w-full max-w-4xl h-[400px] md:h-[600px] flex items-center justify-center">
          <AnimatePresence mode="wait">
            ...
            <motion.div
              ...
              className="absolute z-10 w-[240px] md:w-[350px] aspect-[3/4] rounded-xl overflow-hidden shadow-2xl border border-[var(--color-border)]"
              style={{ backgroundColor: 'var(--color-surface)' }}
            >
              <img src={screenshots[1]} alt="" className="w-full h-full object-cover opacity-80" />
            </motion.div>
            ...
            <motion.div
              ...
              style={{ backgroundColor: 'var(--color-surface)' }}
            >
              <img src={screenshots[2]} alt="" className="w-full h-full object-cover opacity-80" />
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute z-20 w-[260px] md:w-[380px] aspect-[3/4] rounded-xl overflow-hidden shadow-2xl border border-[var(--color-border-light)]"
              style={{ backgroundColor: 'var(--color-surface)' }}
            >
